...
const ACHIEVEMENTS: Achievement[] = [
  {
    ...
    color: '#FFD700',
    points: 50,
    description: 'Master of Knowledge - Complete all subjects with excellence',
    requirement: 5,
    progress: 5,
  },
  {
    ...
    color: '#4CAF50',
    points: 50,
    description: 'Experience all AR models in the app',
    requirement: 3,
    progress: 3,
  },
  {
    ...
    color: '#2196F3',
    points: 30,
    description: 'Complete 10 lessons in record time',
    requirement: 10,
    progress: 4,
  },
  {
    ...
    color: '#FF9800',
    points: 40,
    description: 'Achieve perfect scores in all quizzes',
    requirement: 5,
    progress: 2,
  },
];
...
const GAMES: Game[] = [
  {
    id: '1',
    title: 'Number Ninja',
    description: 'Master mathematics through fun puzzles and challenges!',
    difficulty: 'Easy',
    rating: 4,
    points: 15,
    subject: 'Mathematics',
  ...
  {
    id: '2',
    title: 'World Explorer AR',
    description: 'Travel the world in AR and learn about different cultures',
    difficulty: 'Medium',
    rating: 5,
    points: 20,
  ...
  },
  {
    ...
    description: 'Conduct virtual experiments and discover scientific wonders',
    difficulty: 'Medium',
    rating: 4,
    points: 20,
    subject: 'Science',
  ...
  },
  {
    id: '4',
    title: 'Melody Master',
    description: 'Learn music through interactive AR instruments',
    difficulty: 'Easy',
    rating: 5,
    points: 15,
    subject: 'Music',
  ...
  },
  {
    id: '5',
    title: 'Word Wizard',
    description: 'Cast spelling spells and master vocabulary',
    difficulty: 'Medium',
    rating: 4,
    points: 20,
    subject: 'Language',
  ...
  },
  {
    id: '6',
    title: 'Body Explorer',
    description: 'Journey through the human body in amazing 3D',
    difficulty: 'Hard',
    rating: 5,
    points: 25,
    subject: 'Biology',
  ...
  },
  {
    id: '7',
    title: 'Space Voyager',
    description: 'Explore the solar system with interactive AR models',
    difficulty: 'Medium',
    rating: 5,
    points: 20,
    subject: 'Astronomy',
